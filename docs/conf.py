...
release = pytest_splinter4.__version__
...
htmlhelp_basename = 'pytest-splinter4-doc'
...
latex_documents = [
    ('index', 'pytest-splinter4.tex', u'pytest-splinter4 Documentation', AUTHOR, 'manual'),
]
...
man_pages = [
    ('index', 'pytest-splinter4', u'pytest-splinter4 Documentation',
     [AUTHOR], 1)
]
...
texinfo_documents = [
    ('index', 'pytest-splinter4', u'pytest-splinter4 Documentation',
        AUTHOR, 'pytest-splinter4', 'splinter pytest testing framework integration.',
        'Miscellaneous'),
]
